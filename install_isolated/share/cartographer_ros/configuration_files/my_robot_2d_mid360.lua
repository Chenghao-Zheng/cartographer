...
options = {
  ...
  -- 有IMU的link就设置成imu的link，没有的就设置成base_link
  -- 2026-02-06 10-11修改 tracking_frame published_frame odom_frame 需要base_footprint
  tracking_frame = "livox_frame",              -- 将所有传感器数据转换到这个坐标系下
  published_frame = "livox_frame",            -- tf: map -> footprint
  ...
  -- num_laser_scans/num_point_clouds/num_multi_echo_laser_scans 不能同时为0 因为至少需要一个雷达数据
