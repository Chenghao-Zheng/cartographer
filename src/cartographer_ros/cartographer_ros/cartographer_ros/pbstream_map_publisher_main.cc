/*
 * @Author: your name
 * @Date: 2024-04-16 16:35:02
 * @LastEditTime: 2024-04-17 21:23:22
 * @LastEditors: your name
 * @Description: 
 * @FilePath: /Cartographer_Locatization/src/cartographer_ros/cartographer_ros/cartographer_ros/pbstream_map_publisher_main.cc
...
DEFINE_double(resolution, 0.1, "Resolution of a grid cell in the drawn map.");
